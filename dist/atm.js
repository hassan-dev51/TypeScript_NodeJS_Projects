...
async function AtmTransaction() {
    ...
    switch (askedOperation.operations) {
        case "Deposit":
            ...
            console.log(`You deposite ${deposit_amount.deposite} rupess\nYour current amount is ${deposit_amount.deposite + current_balcance}`);
            break;
        case "Fund Transfer":
            ...
            if (Transfer_amount.transfer > current_balcance) {
                ...
                console.log(`You Transfer ${chalk.red(Transfer_amount.transfer)} rupess to the ${Transfer_amount.receiver}\nYour current amount is ${chalk.green(current_balcance - Transfer_amount.transfer)}`);
            }
            break;
        case "Balance":
            console.log(`Your current balcance is ${chalk.bgCyan(chalk.green(current_balcance))}`);
            break;
        case "Withdraw":
            ...
            console.log(`You withdraw ${chalk.red(withdraw_amount.withdraw)} rupess\nYour current amount is ${chalk.green(current_balcance - withdraw_amount.withdraw)}`);
            break;
        case "Pay bills":
        ...
        case "Show Account Details":
            console.log(`Your account details\nYour Login Number is ${chalk.bgBlue(chalk.cyan(user_login))}\nYour Login Password is ${chalk.red(user_pin)}\nYour current balnce is ${chalk.blue(current_balcance)}`);
            break;
        case "Exit":
